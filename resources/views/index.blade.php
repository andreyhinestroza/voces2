...
<head>
    ...
    <style>
        ...
        body {
            ...
            /* Color institucional claro de respaldo */
        }
        ...
        .btn-google {
            ...
            margin-left: 1.5rem;
            /* separa del botón anterior */
            margin-top: 0.25rem;
            /* ajusta altura vertical */
        }
    ...
    <section class="hero text-center p-0 m-0">
        <div id="sliderHero" class="carousel slide" data-bs-ride="carousel" data-bs-interval="4000">
                    ...
                    <div class="slide-bg" style="background-image: url('{{ asset('img/100.jpg') }}');">
                        <div class="overlay">
                            ...
                            <div class="d-flex justify-content-center gap-3 mt-4">
                                ...
                                <a href="{{ route('comunidad') }}" class="btn btn-warning btn-lg me-2 animated-text">
                                    Votaciones
                                </a>
            ...
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#sliderHero" data-bs-slide-to="0" class="active"
            ...
            <div class="col-md-4 mb-4">
                <div class="card-credencial h-100 d-flex flex-column justify-content-between">
                    <div>
                        ...
                        <p>Sube un video ya grabado mostrando tu talento vocal, copiando el enlace de YouTube en nuestra
                            plataforma.</p>
                    </div>
                    <div class="mt-auto">
                        @auth
                            @if(Auth::user()->rol === 'participante')
                                <a href="javascript:void(0)" class="btn btn-lg custom-btn-video" data-bs-toggle="modal"
                                    data-bs-target="#subirVideoModal">
                                    📹 Subir Video
                                </a>
                            @else
                                <a href="javascript:void(0)" class="btn btn-lg custom-btn-video" data-bs-toggle="modal"
                                    data-bs-target="#convertirseModal">
                                    📹 Subir Video
                                </a>
                            @endif
                        @else
                            <a href="{{ route('auth.google') }}" class="btn btn-lg custom-btn-video"
                                title="Inicia sesión para subir video">
                                📹 Subir Video
                            </a>
                        @endauth
                    </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card-credencial h-100 d-flex flex-column justify-content-between">
                    <div>
                        ...
                        <p>Conecta con artistas locales, guarda listas, vota por tus favoritos y comenta en sus
                            presentaciones.</p>
                    </div>
                    <div class="mt-auto">
            ...
            <div class="col-md-4 mb-4">
                <div class="card-credencial h-100 d-flex flex-column justify-content-between text-center">
                    <div>
                        ...
                        <p>Visualiza los videospor categorías como salsa, pop, folclor y más, celebra la diversidad
                            musical.</p>
                    </div>
                    <div class="mt-auto">
    ...
    <section class="container my-5 bg-white p-4 rounded shadow-sm">
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <p>Únete a nuestra comunidad de artistas candelarios. Sube tu video, participa en concursos y conecta
                    con tu pueblo.</p>
                <a href="{{ route('auth.google') }}" class="btn btn-primary btn-lg px-4 py-2 mt-3"
                    style="display: inline-flex; align-items: center; gap: 0.5rem;">
                    <img src="{{ asset('img/logogoogle.png') }}" alt="Google" class="rounded-circle bg-white p-1"
                    ...
                    <div class="card h-100 shadow-sm border-0" style="border-radius: 8px;">
                        <div class="card-body">
                            ...
                            <p class="card-text text-center text-muted">
                                Explora lo mejor de nuestros género {{ ucfirst($item['genero']) }} en nuestra comunidad
                                Candelareña.
                            </p>

                            @if($item['video'])
                                <div class="ratio ratio-16x9 mb-3">
                                    <iframe id="player-{{ $item['video']->id }}" src="{{ $item['video']->embed_url }}"
                    ...
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body">
                            ...
                            <div class="ratio ratio-16x9">
                                <iframe id="player-recientes-{{ $video->id }}" src="{{ $video->embed_url }}" frameborder="0"
...
<div class="modal fade" id="convertirseModal" tabindex="-1" aria-labelledby="convertirseModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <!-- Cuerpo -->
            <div class="modal-body">
                <p>Para subir videos debes ser participante. ¿Quieres cambiar tu rol ahora y unirte a la comunidad de
                    artistas?</p>
            </div>
